...
export default function Index() {
  return (
    <Layout title="Home / Peek-Rakshak">
      <IndexNavbar fixed />
        ...
        <div className="container mx-auto items-center flex flex-wrap">
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-32 sm:pt-0">
              ...
              Peek-Rakshak - Smart Agriculture
              </h2>
              <p className="mt-4 text-lg leading-relaxed text-blueGray-500">
              Peek-Rakshak is a software application that helps farmers manage and
            ...
            <div className="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-32">
              <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-blueGray-700">
                ...
                <blockquote className="relative p-8 mb-4">
                  ...
                  Peek-Rakshak - The Farming Assistant
                  </h4>
                  <p className="text-md font-light mt-2 text-white">
                  Peek-Rakshak is a software application that helps farmers manage
                ...
                <div className="w-full md:w-6/12 px-4">
                  <div className="relative flex flex-col mt-4">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      Peek-Rakshak allows you to identify dangerous crop diseases
                  ...
                  <div className="relative flex flex-col min-w-0 mt-4">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <p className="mb-4 text-blueGray-500">
                        ...
                        nutrients. Know the right amount from Peek-Rakshak.
                      </p>
                    </div>
                  </div>
                  <div className="relative flex flex-col min-w-0">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <p className="mb-4 text-blueGray-500">
                        ...
                        weather with predictions from Peek-Rakshak.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="container mx-auto overflow-hidden pb-20">
          <div className="flex flex-wrap items-center">
            <div className="w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-48">
              ...
              Peek-Rakshak allows you to identify dangerous crop diseases and apply
          ...
          <div className="flex flex-wrap items-center pt-32">
            ...
            <div className="w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-48">
              ...
              <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-600">
                ...
                the right amount from Peek-Rakshak.
              </p>
              <div className="block pb-6">
                <span className="text-xs font-semibold inline-block py-1 px-2  rounded-full text-blueGray-500 bg-white uppercase last:mr-0 mr-2 mt-2">
                  Increased Efficiency
          ...
          <div className="flex flex-wrap items-center pt-32">
            ...
            <div className="w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-48">
              ...
              <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-600">
                ...
                with predictions from Peek-Rakshak.
              </p>
              <div className="block pb-6">
                <span className="text-xs font-semibold inline-block py-1 px-2  rounded-full text-blueGray-500 bg-white uppercase last:mr-0 mr-2 mt-2">
                  Improved Planning
