            ...
            <div className="px-6 py-4 border-0 rounded relative my-4">
              ...
              >
                ...
                <div className="flex items-center">
                  ...
                  <p class="text-lg ml-4 color-black">{output}</p>
                </div>
              </div>
              ...
              <div className="mt-4">
                ...
                <p class="font-bold text-xl">Always follow these general guidelines when handling fertilizers: </p>
                
                <p class="text-lg font-semibold">
Get your soil tested and use the results to purchase the fertilizer needed. Fertilizer shouldn’t be opened and then sit on a shelf for months – it loses its effectiveness over time.
Check for local ordinance to be sure when fertilizers can be applied.</p>
<p class="text-lg font-semibold">
Always read and follow the label directions.If possible, mix and load fertilizers at the place you plan to apply them. Handle and store fertilizer away from wellheads and surface water. Avoid mixing on hard surfaces like driveways.
Do not fertilize before heavy rainfall or within 10 feet of any water body.</p>
<p class="text-lg font-semibold">
Make sure to calibrate all tools prior to application. To do this, simply follow the manufacturer’s label and recommendations.</p>
<p class="text-lg font-semibold">
Immediately recover and reuse any spilled fertilizer (especially on hard surfaces like a driveway) and properly dispose of any unneeded fertilizer.</p>
<p class="text-lg font-semibold">
Store and secure fertilizer in their original containers above ground. Put them in a safe place so they don’t leech into the environment when in storage.</p>
              </div>
